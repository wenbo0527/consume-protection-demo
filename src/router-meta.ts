...
export const ROUTE_META: RouteMetaDef[] = [
  ...
  { path: 'agent/customer-search', name: 'AgentCustomerSearch', title: '客户画像查询', showInMenu: true, menuParent: '客户', menuOrder: 1 },
  { path: 'agent/customer/:id', name: 'AgentCustomer', title: '客户画像', showInMenu: false },
  { path: 'agent/ticket-create', name: 'AgentTicketCreate', title: '创建工单', showInMenu: true, menuParent: '工单', menuOrder: 1 },
  { path: 'agent/ticket/:id', name: 'AgentTicketDetail', title: '工单详情', showInMenu: false },
  { path: 'agent/knowledge', name: 'AgentKnowledge', title: '知识检索', showInMenu: true, menuParent: '知识', menuOrder: 1 },
  { path: 'agent/reg-import', name: 'AgentRegImport', title: '监管转诉建单', showInMenu: true, menuParent: '工单', menuOrder: 2 },
  { path: 'agent/batch', name: 'AgentBatch', title: '批量作业', showInMenu: true, menuParent: '工单', menuOrder: 3 },

  // 业务执行
  { path: 'business/desk', name: 'BusinessDesk', title: '工作台', showInMenu: true, menuParent: '业务', menuOrder: 1 },
  ...
  { path: 'business/credit', name: 'BusinessCredit', title: '征信异议', showInMenu: true, menuParent: '业务', menuOrder: 5 },
  { path: 'business/transfer', name: 'BusinessTransfer', title: '转诉与调解', showInMenu: true, menuParent: '业务', menuOrder: 6 },

  // 管理
  { path: 'manage/dashboard', name: 'ManageDashboard', title: '驾驶舱', showInMenu: true, menuParent: '管理', menuOrder: 1 },
  ...
  { path: 'manage/knowledge', name: 'ManageKnowledge', title: '知识管理', showInMenu: true, menuParent: '管理', menuOrder: 4 },
  { path: 'manage/workflow-monitor', name: 'ManageWorkflowMonitor', title: '工单流转监控', showInMenu: true, menuParent: '管理', menuOrder: 5 },
  { path: 'manage/quality', name: 'ManageQuality', title: '质检管理', showInMenu: true, menuParent: '运营', menuOrder: 1 },
  ...
  { path: 'manage/billing', name: 'ManageBilling', title: '票据合同', showInMenu: true, menuParent: '运营', menuOrder: 4 },
  { path: 'manage/rectify', name: 'ManageRectify', title: '整改工作台', showInMenu: true, menuParent: '溯源整改', menuOrder: 1 },
  ...
  // 审查
  { path: 'review/pending', name: 'ReviewPending', title: '待审查', showInMenu: true, menuParent: '审查', menuOrder: 1 },
