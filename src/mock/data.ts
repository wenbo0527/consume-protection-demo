...
export const customers: Customer[] = [
  {
    ...
    overdueCount: 1,
    maxOverdueDays: 45,
    riskTags: ['blacklist', 'complaint'],
    tagSources: ['投诉信息库', '征信系统'],
    complaintCount6m: 4,
    lastComplaintTime: '2026-07-10 14:32',
    lastComplaintType: '催收频次',
    ongoingTickets: [
  ...
  },
  {
    ...
    tagSources: ['声纹识别'],
    complaintCount6m: 2,
    lastComplaintTime: '2026-06-28 10:15',
    lastComplaintType: '身份核验',
    ongoingTickets: [
  ...
  },
  {
    id: 'C003',
    name: '周志远',
    idCardMask: '440305********7711',
    phone: '136****2233',
    creditStatus: 'overdue',
    loanBalance: 156800.0,
    loanCount: 3,
    overdueCount: 2,
    maxOverdueDays: 92,
    riskTags: ['threat', 'complaint'],
    tagSources: ['呼叫中心备注', '投诉信息库'],
    complaintCount6m: 6,
    lastComplaintTime: '2026-07-14 16:48',
    lastComplaintType: '扬言投诉',
    ongoingTickets: [
...
export const alerts: AlertItem[] = [
  ...
  },
  {
    ...
    typeLabel: '监管件超时',
    level: 'urgent',
    title: '监管件 GD-20260709-0015 临近超时',
    desc: '工单已处理 5 天,剩余 2 天即将超时(监管件处理时限7天)',
    triggerTime: '2026-07-15 09:00',
    status: 'alert_open',
    relatedTicket: 'GD-20260709-0015'
  },
  {
    id: 'AL-2026-0510',
    type: 'collection',
    typeLabel: '催收频次超限',
    level: 'warning',
    title: '客户 C003 周志远 月度催收触达 28 次',
    desc: '超过监管上限 20 次/月,建议立即停催',
    triggerTime: '2026-07-14 18:30',
    status: 'alert_handle',
    relatedTicket: 'GD-20260714-0008'
  },
  {
    id: 'AL-2026-0509',
    type: 'regulator',
    ...
    triggerTime: '2026-07-14 10:00',
    status: 'alert_done',
    relatedTicket: 'GD-20260708-0099'
  },
  {
    id: 'AL-2026-0508',
    type: 'volume',
    ...
    triggerTime: '2026-07-13 16:30',
    status: 'alert_upgrade'
  },
  {
    id: 'AL-2026-0507',
    type: 'collection',
    typeLabel: '催收频次超限',
    level: 'info',
    title: '客户 C001 刘建国 接近频次上限',
    desc: '月度催收触达 18 次,上限 20 次',
    triggerTime: '2026-07-12 11:00',
    status: 'alert_verified',
    relatedTicket: 'GD-20260712-0001'
  }
]
...
export const blackList: BlackListItem[] = [
  ...
  },
  {
    id: 'BL-0005',
    name: '王某某',
    idCardMask: '440305********2204',
    phone: '136****0204',
    type: 'abnormalAgent',
    typeLabel: '异常代理',
    reason: '通话内容异常,身份核验未通过',
    source: '人工标注',
...
export const knowledge: (KnowledgeItem & { relatedCategories: string[]; relatedReasons: string[]; scene: string })[] = [
  {
    id: 'K001',
    title: '催收频次合规标准 (2026版)',
    category: 'rule',
    categoryLabel: '业务规则',
    content:
      '根据《消费金融公司催收行为指引》,个人贷款月催收频次不超过 20 次,日催收频次不超过 3 次。早 8:00 前、晚 21:00 后不得催收。',
    source: '消保审查·SC-2026-0075',
    updatedAt: '2026-07-10',
    status: 'active',
    views: 1248,
    relatedCategories: ['债务催收'],
    relatedReasons: ['催收频次'],
    scene: '催收频次'
  },
  {
    ...
    categoryLabel: '话术模板',
    content:
      '尊敬的客户,您申请的征信异议已受理,我们将在 5 个工作日内完成核实并反馈。我们会调取您的征信报告进行核对,如信息有误将在 5 个工作日内向征信机构申请更正...',
    source: '消保审查·SC-2026-0072',
    updatedAt: '2026-07-08',
    status: 'active',
    views: 856,
    relatedCategories: ['个人金融信息'],
    relatedReasons: ['征信异议'],
    scene: '征信异议'
  },
  {
    ...
    source: '消保审查·SC-2026-0078',
    updatedAt: '2026-07-14',
    status: 'pending',
    views: 0,
    relatedCategories: ['贷款'],
    relatedReasons: ['额度查询', '产品咨询'],
    scene: '贷款产品'
  },
  {
    id: 'K004',
  ...
  },
  {
    ...
    categoryLabel: '话术模板',
    content:
      '听到扬言时:1)立即稳定客户情绪,避免激化;2)记录关键信息(时间、地点、媒体);3)通知组长;4)考虑转接紧急处理流程;5)24 小时内回访跟踪。',
    source: '消保审查·SC-2026-0068',
  ...
  },
  {
    ...
    categoryLabel: '业务规则',
    content:
      '客户对息费计算有异议时,需调取借据台账、还款记录、合同条款进行核对。如计算无误,提供详细计算明细;如有错误,立即提交 OA 审批调整。',
    source: '消保审查·SC-2026-0065',
    updatedAt: '2026-06-25',
    status: 'active',
    views: 528,
    relatedCategories: ['定价收费'],
    relatedReasons: ['息费争议'],
    scene: '息费争议'
  },
  {
    ...
    categoryLabel: '业务规则',
    content:
      '客户已结清贷款的,可线上自助开具结清证明。需验证:①贷款状态已结清;②无未结清借据。审核通过后 1 个工作日内出具。',
    source: '消保审查·SC-2026-0060',
    updatedAt: '2026-06-15',
    status: 'active',
    views: 412,
    relatedCategories: ['其他'],
    relatedReasons: ['结清证明'],
    scene: '结清证明'
  },
  {
    ...
    categoryLabel: '话术模板',
    content:
      '接到疑似代理代办时:1)要求客户提供本人身份证号后四位;2)询问合同信息;3)对比声纹;4)询问近期交易记录。任一项不符即转接反欺诈流程。',
    source: '消保审查·SC-2026-0058',
...
export const batchJobs: {
  ...
  successCount: number
  failedCount: number
  status: 'processing' | 'partial' | 'done' | 'warning'
  createdAt: string
  creator: string
...
export const tagSystem: {
...
}[] = [
  {
    ...
    name: '黑名单',
    category: '风险标签',
    definition: '法院失信被执行人或重大违约客户',
    triggerRule: '法院数据同步命中',
    action: '限制呼入/呼出+醒目提示',
    needApproval: true,
    status: 'active'
  },
  {
    ...
    name: '投诉倾向',
    category: '风险标签',
    definition: '近6个月投诉≥3次',
    triggerRule: '投诉次数统计',
    action: '来电黄色提示+进入投诉信息库',
    needApproval: false,
    status: 'active'
  },
  {
...
export const myComplaints: Complaint[] = [
  {
    ...
    statusLabel: '处理中',
    progress: 70,
    submitTime: '2026-07-12 09:15',
    expectedTime: '2026-07-19',
    type: '催收频次'
  },
  {
    id: 'GD-20260515-0078',
    ...
    statusLabel: '调解中',
    progress: 50,
    submitTime: '2026-05-15 14:22',
    expectedTime: '2026-05-30',
    type: '息费争议'
  },
  {
    id: 'GD-20260402-0033',
