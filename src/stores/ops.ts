...
function buildSeed() {
  const agents: Agent[] = [
    { id: 'U001', name: '张敏', role: 'agent', workNo: 'A001', joinedAt: '2024-03-15', skills: ['电话', '投诉'], monthlyTicketCount: 86, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'oncall' },
    { id: 'U002', name: '王浩', role: 'agent', workNo: 'A002', joinedAt: '2024-05-20', skills: ['电话', '在线客服'], monthlyTicketCount: 92, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'idle' },
    { id: 'U003', name: '李伟', role: 'business', workNo: 'B001', joinedAt: '2023-09-10', skills: ['协商还款', '停催停扣'], monthlyTicketCount: 45, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'oncall' },
    { id: 'U004', name: '陈静', role: 'business', workNo: 'B002', joinedAt: '2024-07-01', skills: ['征信异议', '转调解'], monthlyTicketCount: 38, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'idle' },
    { id: 'U005', name: '刘丽', role: 'review', workNo: 'R001', joinedAt: '2023-11-05', skills: ['消保审查', '工单审查'], monthlyTicketCount: 0, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'oncall' },
    { id: 'U006', name: '王芳', role: 'review', workNo: 'R002', joinedAt: '2024-02-18', skills: ['消保审查'], monthlyTicketCount: 0, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'offline' },
    { id: 'U007', name: '陈强', role: 'manage', workNo: 'M001', joinedAt: '2022-04-01', skills: ['管理驾驶舱'], monthlyTicketCount: 0, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'oncall' },
    { id: 'U008', name: '赵雪', role: 'agent', workNo: 'A003', joinedAt: '2024-10-12', skills: ['12345', '在线客服'], monthlyTicketCount: 64, monthlyAvgScore: 0, monthlyRectifyCount: 0, status: 'idle' }
  ]
  ...
  const leaves: LeaveRequest[] = [
    { id: 'LV-20260715-0001', agentId: 'U002', type: '调休', startDate: '2026-07-16', endDate: '2026-07-16', reason: '处理家庭事务', status: 'approved', applicantAt: '2026-07-13 09:30', approver: '陈强', approvedAt: '2026-07-13 11:00' },
    { id: 'LV-20260714-0002', agentId: 'U008', type: '年假', startDate: '2026-07-20', endDate: '2026-07-24', reason: '年中休假', status: 'pending', applicantAt: '2026-07-14 16:00' }
  ]
